...
from .kmlbdh_delete_folder import NODE_CLASS_MAPPINGS as fc_mappings, NODE_DISPLAY_NAME_MAPPINGS as fc_display

# Combine all mappings
NODE_CLASS_MAPPINGS = {}
NODE_CLASS_MAPPINGS.update(vc_mappings)
NODE_CLASS_MAPPINGS.update(rc_mappings)
NODE_CLASS_MAPPINGS.update(fc_mappings)

NODE_DISPLAY_NAME_MAPPINGS = {}
NODE_DISPLAY_NAME_MAPPINGS.update(vc_display)
NODE_DISPLAY_NAME_MAPPINGS.update(rc_display)
NODE_DISPLAY_NAME_MAPPINGS.update(fc_display)
